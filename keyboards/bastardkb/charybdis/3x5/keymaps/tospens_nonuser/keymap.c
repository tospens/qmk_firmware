...
#define LAYOUT_LAYER_FUNCTION                                                                 \
    ...
    ______________HOME_ROW_ALGR_L______________, SELWORD,   KC_F1,   KC_F2,   KC_F3,  KC_F10, \
...
#define LAYOUT_LAYER_MEDIA                                                                    \
    ...
    _______________DEAD_HALF_ROW_______________,   RESET, EEP_RST, XXXXXXX, XXXXXXX, XXXXXXX, \
...
#define LAYOUT_LAYER_POINTER                                                                  \
    ...
    XXXXXXX, DRGSCRL, SNIPING, SELWORD, XXXXXXX, DPI_MOD, S_D_MOD, XXXXXXX, XXXXXXX, XXXXXXX, \
                      KC_BTN2, KC_BTN1, KC_BTN3, KC_ENT, KC_DEL

/**
 * \brief Navigation layer.
 *
 * Primary right-hand layer (left home thumb) is navigation and editding. Cursor
...
#define LAYOUT_LAYER_NAVIGATION                                                               \
    ...
    _____________WINDOW_MANAGEMENT_____________,  KC_INS, KC_HOME, KC_PGDN, KC_PGUP,  KC_END, \
...
#define LAYOUT_LAYER_NUMERAL                                                                  \
    ...
    KC_QUOT,    KC_4,    KC_5,    KC_6,  KC_EQL, ______________HOME_ROW_GACS_R______________, \
     KC_GRV,    KC_1,    KC_2,    KC_3, KC_BSLS, U_NA,    KC_AE,    KC_OE,    KC_AA,    U_NA, \
