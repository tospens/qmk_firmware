...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |----||-------------------------------|
   * | F15|| LAlt  | _FN |Ctl|  Space  |  0|
   * `----'`-------------------------------'
   */
    [_BASE] = LAYOUT(
		        KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, 
		        KC_ENT, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_7, 
		KC_F13, KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_8, 
		KC_F14, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_9, 
		KC_F15, KC_LALT, OSL(_FN), KC_LCTL, KC_SPC, LT(_ARROW, KC_0)
    ),
  /* Arrows Layer
   * ,-----------------------------------------.
   * |     |       |    |    |     |   |   |   |
