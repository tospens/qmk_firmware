...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[BASE] = LAYOUT(
		...
		KC_TAB  , KC_LGUI , KC_LALT ,MO(LOWER),MO(GAME)  , KC_SPC  , KC_MUTE , KC_ENT  , MO(RAISE) ,KC_BSPC_DEL, KC_RALT , KC_RGUI , KC_RCTRL
	),
    [LOWER] = LAYOUT(
	...
	[RAISE] = LAYOUT(
		...
		_______	, KC_MINS , KC_VOLD, KC_MUTE, KC_VOLU , _______           , _______, KC_LEFT, KC_UP  , KC_DOWN, KC_RGHT, _______ ,
