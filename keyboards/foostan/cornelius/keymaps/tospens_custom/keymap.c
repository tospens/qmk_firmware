...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
    ...
    KC_ESC,  HOME_A,            HOME_S,  HOME_D,            HOME_F,            KC_G,              KC_H,              HOME_J,            HOME_K,          HOME_L,   HOME_SCLN,
    KC_LSFT, KC_Z,  HOME_X,  KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,         KC_DOT,   KC_SLSH,
    KC_LCTL, KC_DOWN,              KC_UP,     LT(MEDIA, KC_ESC), LT(NAV, KC_SPC),   LT(MOUSE, KC_TAB), LT(SYM, KC_ENT),   LT(NUM, KC_BSPC),  LT(FUN, KC_DEL), U_NP,     U_NP
  ),
  [NAV] = LAYOUT(
    RESET,   U_NA,    U_NA,    U_NA,    U_NA,    U_NA,    U_RDO,   U_PST,   U_CPY,   U_CUT,   U_UND, U_NU
    U_NA, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, U_NA,    KC_CAPS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, U_NU
    U_NA, U_SLFT,  U_WLFT,  U_WNUP,  U_WRGT,  U_SRGT,  KC_INS,  KC_HOME, KC_PGDN, KC_PGUP, KC_END, U_NU
    U_NA, U_NA,    U_NA,    U_NA,    U_NA,    U_NA,    KC_ENT,  KC_BSPC, KC_DEL,  U_NA,    U_NA, U_NU
  ),
  [MEDIA] = LAYOUT(
    RESET, U_NA,   U_NA,    U_NA,    U_NA,    U_NA,    RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, U_NU
    ...
    U_NA, U_NA,    U_NA,    U_NA,    U_NA,    U_NA,    KC_MSTP, KC_MPLY, KC_MUTE, U_NP,    U_NP, U_NU
  ),
  [NUM] = LAYOUT(
  ...
  [SYML] = LAYOUT(
    KC_QUOT, KC_LABK, KC_RABK, KC_DQUO, KC_DOT , U_NA,    U_NA,    U_NA,    U_NA,    RESET,
    KC_EXLM, KC_MINS, KC_PLUS, KC_EQL , KC_HASH, U_NA,    KC_RSFT, KC_RCTL, KC_LALT, KC_RGUI,
    KC_CIRC, KC_SLSH, KC_ASTR, KC_BSLS, UPDIR,   U_NA,    U_NA,    U_NA,    KC_ALGR, U_NA,
    U_NP,    U_NP,    KC_LPRN, KC_RPRN, KC_UNDS, U_NA,    U_NA,    U_NA,    U_NP,    U_NP
  ),
  [SYMR] = LAYOUT(
    RESET, U_NA,   U_NA,    U_NA,    U_NA,    U_NA,    KC_AMPR, SCOPE  , KC_LBRC, KC_RBRC, KC_PERC, U_NU,
    U_NA, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, U_NA,    KC_PIPE, KC_COLN, KC_LPRN, KC_RPRN, KC_QUES, U_NU,
    U_NU, U_NA,    KC_ALGR, U_NA,    U_NA,    U_NA,    KC_TILD, KC_DLR , KC_LCBR, KC_RCBR, KC_AT  , U_NU,
    U_NU, U_NP,    U_NP,    U_NA,    U_NA,    U_NA,    KC_UNDS, KC_MINS, SELWORD, U_NP,    U_NP   , U_NU
  ),
  [FUN] = LAYOUT(
